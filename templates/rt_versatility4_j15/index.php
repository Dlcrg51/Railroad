		...
		<div id="bottom">
			...
			<?php endif; ?>
				...
				<div class="footer-module">
					&copy; Copyright - <?php echo date('Y'); ?><?php echo " - Owego Harford Railway, Inc | " ?></a><a href="http://www.s-go.net/" title="s-go Consulting" class="nounder" target="blank"><?php echo "Website & Hosting by s-go Consulting" ?></a>
				</div>
				<?php endif; ?>
...
<script type="text/javascript">
try {
var pageTracker = _gat._getTracker("UA-12984278-5");
